  ...
  render() {
    return (
      <View style={styles.container}>
        <TextInput style={styles.inputText} autoFocus={true} placeholder='Usuário'
          onChangeText={(value) => this.setState({ login: value })} />
        <TextInput style={styles.inputText} secureTextEntry={true} placeholder='Senha'
...
/*
Comentado para navegação em Abas
